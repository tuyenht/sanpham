(function () {
	...
	var default_lang = "vi"; // set Default Language
	...
	function setLanguage(lang) {
		if (document.getElementById("header-lang-img")) {
			if (lang == "en") {
				...
				document.getElementById("header-lang-img").src = "/assets/images/flags/jp.svg";
			} else if (lang == "gr") {
	...
	function initTwoColumnActiveMenu() {
		feather.replace();
		var a = document.querySelector('#navbar-nav a.nav-link.active');
		if (a){
			a.classList.add("active");
			var parentCollapseDiv = a.closest(".collapse.menu-dropdown");
			if (parentCollapseDiv && parentCollapseDiv.parentElement.closest(".collapse.menu-dropdown")) {
			...
			var a = document.getElementById("two-column-menu").querySelector('[href="' + currentPath + '"]');
	...
	function initActiveMenu() {
		var activeLinks = document.querySelectorAll('#navbar-nav a.nav-link.active');
		if (activeLinks.length > 0) {
			activeLinks.forEach(activeLink => {
				var parentCollapseDiv = activeLink.closest(".collapse.menu-dropdown");
				while (parentCollapseDiv) {
					parentCollapseDiv.classList.add("show");
					let parentLink = parentCollapseDiv.previousElementSibling;
