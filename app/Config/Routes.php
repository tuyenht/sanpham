...
//navigation
$routes->get($rtAdmin . '/themes', 'AdminController::theme');
...
//blog
$routes->get($rtAdmin . '/add-post', 'BlogController::addPost');
$routes->get($rtAdmin . '/posts', 'BlogController::posts');
$routes->get($rtAdmin . '/edit-post/(:num)', 'BlogController::editPost/$1');
$routes->get($rtAdmin . '/topics', 'BlogController::categories');
$routes->get($rtAdmin . '/edit-topic/(:num)', 'BlogController::editCategory/$1');
