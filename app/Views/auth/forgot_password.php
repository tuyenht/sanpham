                    ...
                    <div class="col-12">
                        ...
                        <form action="<?= base_url('forgot-password-post'); ?>" method="post" id="form_validate">
                            ...
                            <div class="form-group m-b-30">
                                <input type="email" name="email" autofocus="autofocus" class="form-control auth-form-input" placeholder="<?= trans("email_address"); ?>" value="<?= old("email"); ?>" maxlength="255" required>
                            </div>
                            <div class="form-group">
